...
// File contracts/SUSD.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity 0.8.20;


contract SUSD is ERC20, AccessControl {
    mapping(address => bool) private _whitelist;
    bool public whitelistActive;

    constructor(address newAdmin) ERC20("Sakai-Peg USD", "sUSD") {
        _grantRole(DEFAULT_ADMIN_ROLE, newAdmin);
        whitelistActive = false; 
    }

    function mint(address account, uint256 amount) external onlyRole(AccessControl.DEFAULT_ADMIN_ROLE) {
